<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教师职称" prop="jiaoshizhicheng">
          <el-select v-model="ruleForm.jiaoshizhicheng" placeholder="请选择教师职称">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="教师职称" prop="jiaoshizhicheng">
	      <el-input v-model="ruleForm.jiaoshizhicheng"
                placeholder="教师职称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
