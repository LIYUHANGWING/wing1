    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.ziliaoneirong" label="资料内容" prop="ziliaoneirong">
                    <span v-html="ruleForm.ziliaoneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="资料说明" prop="ziliaoshuoming">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.ziliaoshuoming" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ziliaoshuoming" label="资料说明" prop="ziliaoshuoming">
                    <span v-html="ruleForm.ziliaoshuoming"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangchuanshijian = true;
          ...
          if(o=='ziliaoshuoming'){
            this.ruleForm.ziliaoshuoming = obj[o];
	    this.ro.ziliaoshuoming = true;
            continue;
          }
          if(o=='fengmian'){
	...
	this.ruleForm.ziliaoneirong = this.ruleForm.ziliaoneirong.replace(reg,'../../../ssm4i698/upload');
	this.ruleForm.ziliaoshuoming = this.ruleForm.ziliaoshuoming.replace(reg,'../../../ssm4i698/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
