<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="话题简介" prop="huatijianjie">
          <el-input v-model="ruleForm.huatijianjie" 
              placeholder="话题简介" clearable  :readonly="ro.huatijianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="话题简介" prop="huatijianjie">
              <el-input v-model="ruleForm.huatijianjie" 
                placeholder="话题简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="话题内容" prop="huatineirong">
          <el-input v-model="ruleForm.huatineirong" 
              placeholder="话题内容" clearable  :readonly="ro.huatineirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="话题内容" prop="huatineirong">
              <el-input v-model="ruleForm.huatineirong" 
                placeholder="话题内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发起日期" prop="faqiriqi">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.faqiriqi" 
                type="datetime"
                placeholder="发起日期">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.faqiriqi" label="发起日期" prop="faqiriqi">
              <el-input v-model="ruleForm.faqiriqi" 
                placeholder="发起日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='huatijianjie'){
            this.ruleForm.huatijianjie = obj[o];
	    this.ro.huatijianjie = true;
            continue;
          }
          if(o=='huatineirong'){
            this.ruleForm.huatineirong = obj[o];
	    this.ro.huatineirong = true;
            continue;
          }
          if(o=='faqiriqi'){
            this.ruleForm.faqiriqi = obj[o];
	    this.ro.faqiriqi = true;
            continue;
          }
          if(o=='fengmian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huatitaolun/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huatitaolunCrossAddOrUpdateFlag = false;
                  this.parent.search();
